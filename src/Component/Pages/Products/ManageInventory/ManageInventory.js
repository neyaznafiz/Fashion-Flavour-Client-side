    ...
    <div className=" flex lg:mx-auto">
      ...
      <div className="grid items-end pb-9 pl-4">
        <div>
          ...
          >
            <option value="4" selected className="font-semibold ">
              4
            </option>
            <option value="8" className="font-semibold ">
              8
            </option>
          ...
          {[...Array(pageCount).keys()].map((number) => (
            <button
              ...
              className={
                page === number
                  ? "text-zinc-800 m-2 px-4 form-shadow font-semibold flex"
                  : "m-2 px-4 card-shadow font-semibold flex"
              }
            >
              {number + 1}
            </button>
